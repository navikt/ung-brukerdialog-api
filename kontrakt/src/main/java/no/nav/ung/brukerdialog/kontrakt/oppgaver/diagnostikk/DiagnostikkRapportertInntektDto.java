...
public class DiagnostikkRapportertInntektDto extends DiagnostikkOppgaveResponsDto {
    ...
    public DiagnostikkRapportertInntektDto() {
    }

    public DiagnostikkRapportertInntektDto(LocalDate fraOgMed, LocalDate tilOgMed, BigDecimal arbeidstakerOgFrilansInntekt) {
